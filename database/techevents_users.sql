...
-- Table 'users' creation and insertion
...
-- Table 'events' creation and insertion
DROP TABLE IF EXISTS techevents_users.events;
CREATE TABLE techevents_users.events (
  `id` varchar(36) NOT NULL,
